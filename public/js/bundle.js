      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Something went wrong while logging out..');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicGFha2t1bmciLCJhIjoiY2t2N3FudnN2MXdvMzMwcXA4aHJyaHNyYiJ9.Hm0_1VziFItL_zUdYl2LRA';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alert.showAlert)('success', "New User Settings have been successfully saved!");
            }
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(passwordCurrent, newPassword, newPasswordConfirm) {
    var result;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Your password have succcesfully changed!');
...
var stripe = Stripe('pk_test_51JpqYkJlwBvMYQB9botyojcvHSy5qGwTLcpUNky3ItIE7lO7A2xKI9NkKehd85OONfGzVvIZ6LMoGwTJfp6gtt0V00JlPOdZRG');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', 'Something went wrong while processing payment, please try again...');
...
if (userPasswordForm) userPasswordForm.addEventListener('submit', function (event) {
  ...
  (0, _updateSettings.updatePassword)(passwordCurrent, newPassword, newPasswordConfirm);
});
